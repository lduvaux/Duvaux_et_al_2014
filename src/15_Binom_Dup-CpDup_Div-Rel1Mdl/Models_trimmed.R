...
MOD_ALL1 <- Polymorphic ~ LnGeneLength + LnExonLength + Family + Phylog_lvl + Family * Phylog_lvl + LnGeneLength * LnExonLength + (1|Phylog_lvl/Race) + (1|trimmed) + (1|Family/Gene) # + (1|LnGeneLength/LnExonLength)
FAMILY <- "binomial"
DELTA1 <- 10
