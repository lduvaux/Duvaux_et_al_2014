...
MOD_ALL2 <- Duplication ~ LnGeneLength + LnExonLength + Family + LnGeneLength * Family + LnExonLength * Family + (1|Phylog_lvl/Race) + (1|trimmed) + (1|Family/Gene) # + (1|LnGeneLength/LnExonLength) # virer Phylog_lvl car jamais significatif
